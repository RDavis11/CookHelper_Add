package teamjcm.cookhelper_add;
...
public class CookHelper_Add extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cook_helper__add);

        //NEEDS TO BE FIXED
        ingredientList = new ArrayList<String>();
        ingredientAdapter = new ArrayAdapter<String>(this,R.layout.activity_cook_helper__add,R.id.ingredients_view);
